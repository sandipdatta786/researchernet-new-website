...
export const generalFaqs: FaqItem[] = [
  ...
  { q: "Who founded ResearcherNet?", a: "Dr. Asfak Ali (Founder & CEO), Sandip Datta (Co-Founder & Director) and Dr. Suvojit Acharjee (Co-Founder & Architect). Dr. Nandan Gupta, Chairman of the Swami Vivekananda Group of Institutes, is an advisor." },
