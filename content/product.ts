...
export const generalFaqs: FaqItem[] = [
  ...
  { q: "Is ResearcherNet free?", a: "Yes. Individual researchers can use ResearcherNet free. Professional is ₹999 a month and Team / Lab is ₹4,999 a month; institutions license the platform campus-wide from ₹8–12 lakh a year, and pilot institutions receive complimentary first-year access under an MOU." },
