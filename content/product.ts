...
export const generalFaqs: FaqItem[] = [
  ...
  { q: "Who founded ResearcherNet?", a: "Dr. Asfak Ali (Founder & CEO), Sandip Datta (Co-Founder & Director), Dr. Suvojit Acharjee (Co-Founder & Architect) and Utathya Aich (Co-Founder & Full-Stack Lead). Dr. Nandan Gupta, Chairman of the Swami Vivekananda Group of Institutes, is an advisor." },
