...
export const metadata: Metadata = pageMetadata({
  ...
  description: "Free for individual researchers. Institutional licences on request, billed annually in INR with a GST invoice. Professional and Team plans coming soon.",
  path: "/pricing",
});
...
const faqs = [
  ...
  { q: "Is there an academic or student discount?", a: "Yes. Verify with an institutional email to unlock academic pricing when the Professional and Team plans launch." },
  ...
  { q: "What counts as a 'Team'?", a: "A lab or research group that shares projects, lab spaces and video meetings. The Team plan is coming soon; contact us in the meantime and we will scope an institutional licence." },
];
